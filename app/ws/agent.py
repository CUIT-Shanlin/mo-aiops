...
@router.websocket("/ws/agent/workflow")
async def agent_workflow_ws(websocket: WebSocket) -> None:
    ...
    await forward_pubsub(websocket, RedisKey.of(project_id, RedisKey.WS_AGENT))
